...
export async function getTeacherContent(teacherId) {
  try {
    ...
    return error instanceof Error
      ? error.message
      : "Failed to fetch teacher content.";
  }
}
...
export async function uploadContent(content) {
  try {
    ...
    return error instanceof Error ? error.message : "Failed to upload content.";
  }
}
...
export async function getContentStats() {
  try {
    ...
    return error instanceof Error
      ? error.message
      : "Failed to fetch global content statistics.";
  }
}
...
export async function getContentByStatus(status) {
  try {
    ...
    return error instanceof Error
      ? error.message
      : `Failed to fetch content with status: ${status}`;
  }
}
...
export const getLiveTeacherContent = async (teacherId) => {
  try {
    ...
    return error instanceof Error
      ? error.message
      : "Failed to fetch live content for this teacher.";
  }
};
